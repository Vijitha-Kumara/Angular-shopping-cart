...
@Component({
  ...
  <div class="row">  
    <div class="col-md-4"  *ngFor = "let item of __allprdts | filter : __searchedProduct">
        <div class="card"> 
        <div>         
          ...
          <div class="card-body">
            ...
            <button class="btn btn-sm btn-primary" *ngIf="!isAdd" (click)="addToCart(item.p_id,1,'')">Add to Cart</button>
